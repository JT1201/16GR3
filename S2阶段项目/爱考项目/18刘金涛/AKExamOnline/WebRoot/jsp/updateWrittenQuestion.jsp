...
<body>
	<div class="marginLayout">
		<form action="question/question_updateWrittenQuestion" method="post"
			...
			<input type="hidden" name="writtenQuestion.csId"
				value="${param.csId }">
			<table class="marginLayout">
				...
				<tr>
					...
					<td><select id="qtype" name="writtenQuestion.qtype"
				...
				<tr>
					...
					<td><textarea rows="3" cols="30" name="writtenQuestion.qtitle"
							id="qTitle">
				...
				<tr>
					...
					<td><input type="radio" class="options"
						name="writtenQuestion.answer" value="A" checked="checked">A
						<input class="textWidth" type="text"
						name="writtenQuestion.optionA" id="optionA"
						value="${writtenQuestion.optionA }"> <br /> <input
						type="radio" class="options" name="writtenQuestion.answer"
						value="B">B <input class="textWidth" type="text"
						name="writtenQuestion.optionB" id="optionB"
						value="${writtenQuestion.optionB }"> <br /> <input
						type="radio" class="options" name="writtenQuestion.answer"
						value="C">C <input class="textWidth" type="text"
						name="writtenQuestion.optionC" id="optionC"
						value="${writtenQuestion.optionC }"> <br /> <input
						type="radio" class="options" name="writtenQuestion.answer"
						value="D">D <input class="textWidth" type="text"
						name="writtenQuestion.optionD" id="optionD"
						value="${writtenQuestion.optionD }"> <br /></td>
				</tr>
				<tr>
					<td align="right"><font>难易程度:</font></td>
					<td><select name="writtenQuestion.degree">
				...
				<tr>
					...
					<td><input class="textWidth" type="text"
						name="writtenQuestion.chapter" id="chapter"
						value="${writtenQuestion.chapter }"></td>
				</tr>
				<tr>
