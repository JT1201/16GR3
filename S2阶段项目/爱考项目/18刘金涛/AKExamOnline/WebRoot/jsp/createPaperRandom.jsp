	...
	<form action="paper/paper_createByRandom" method="post">
		<table align="center" width="80%" height="80%">
			<tr>
				...
				<td><s:select id="majorSelect"
						list="#{'':'请选择','SCME':'SCME','SCCE':'SCCE'}" name="majorSelect"
						onchange="getCourses()" theme="simple" /> 阶段: <s:select
						id="stageSelect" list="#{'':'请选择','G1':'G1','G2':'G2','G3':'G3'}"
						name="stageSelect" onchange="getCourses()" theme="simple" /> 科目:
					<s:select list="{}" name="course.csId" id="csId" theme="simple"
						headerKey="" headerValue="请选择" onchange="getQuestionMaxNum()" />
					<font color="red">*</font></td>
			</tr>
			<tr>
				<td style="text-align: right;">标题：</td>
				<td><input type="text" name="paper.pname" size="45"> <font
					color="red">*</font></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" name="paper.ptime">分钟<font
					color="red">*</font></td>
			</tr>
			<tr>
				<td style="text-align: right;">单选题：</td>
				<td>简单<input type="text" name="radioEasy" size="2"
					onchange="getQuestionTotal()"> 一般<input type="text"
					name="radioNormal" size="2"> 困难<input type="text"
					name="radioDiff" size="2">
				</td>
			</tr>
			<tr>
				<td style="text-align: right;">多选题：</td>
				<td>简单<input type="text" name="cbEasy" size="2"> 一般<input
					type="text" name="cbNormal" size="2"> 困难<input type="text"
					name="cbDiff" size="2">
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td style="text-align: center;" colspan="2"><input
					type="submit" value="创建试卷"> <input type="reset" value="取消">
				</td>
			</tr>
		</table>
	</form>
